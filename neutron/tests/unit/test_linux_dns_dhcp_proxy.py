...
class TestBase(base.BaseTestCase):
    def setUp(self):
        ...
        self.conf.register_opts(dns_dhcp_proxy.OPTS)
...
class TestDnsDhcpProxy(TestBase):
    ...
    @mock.patch.object(dns_dhcp_proxy.DnsDhcpProxy, "_spawn_dhcp_proxy")
    @mock.patch.object(dns_dhcp_proxy.DnsDhcpProxy, "_spawn_dns_proxy")
    def test_spawn(self, mock_spawn_dns, mock_spawn_dhcp):
        dm = dns_dhcp_proxy.DnsDhcpProxy(self.conf, self.network)
    ...
    def test__spawn_dhcp_proxy(self):
        ...
        with mock.patch.multiple(dns_dhcp_proxy.DnsDhcpProxy,
    ...
    @mock.patch.object(dns_dhcp_proxy.DnsDhcpProxy, 'interface_name')
    ...
    @mock.patch.object(dns_dhcp_proxy.os, 'listdir',
    ...
    @mock.patch.object(dns_dhcp_proxy, '_generate_mac_address',
                       mock.Mock(return_value='77:77:77:77:77:77'))
    @mock.patch.object(dns_dhcp_proxy.DnsDhcpProxy, '_get_relay_device_name',
    ...
    def test_enable_dhcp_dns_inactive(self):
        ...
        with mock.patch.multiple(dns_dhcp_proxy.DnsDhcpProxy,
            ...
            dr = dns_dhcp_proxy.DnsDhcpProxy(self.conf, self.network)
            dr.enable()
    ...
    def test_generate_mac(self):
        mac = dns_dhcp_proxy._generate_mac_address()
        mac_array = mac.split(':')
